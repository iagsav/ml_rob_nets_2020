...
ds_left = robot.getDistanceSensor('ds_left')#Объявление левого 
ds_left.enable(timestep)			       #датчика
ds_right = robot.getDistanceSensor('ds_right')#Объявлеие правого 
ds_right.enable(timestep) 				   #датчика
